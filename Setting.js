...
global.owner = process.env.OWNER_NUMBER  || '255675233245' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://Tonyscot:<password>@cluster0.z1koht7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
global.timezone  = process.env.TIME_ZONE || 'Africa/Dar es salaam' // ADD CORRECT TIMEZONE OR LEAVE IT SAME , OTHERWISE YOU GET ERROS
//=================================================================================


//======================[YOUR CHOICE, CHANGE OR LEAVE IT SAME]=====================
global.sudo  =  process.env.SUDO || "255675233245" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"DRAGON😂🔒",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '29_07_2024_SIGMA_MD_4A1ZmLBJ_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'DRAGON-ᴍᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `DRAGON`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'dragon05😁',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "DRAGON-ᴍᴅ" ,          // ADD YOUR STICKER PACKNAME
  ...
  antifake :   process.env.FAKE_COUNTRY_CODE || '255',     // ANTIFAKE NUMBER CAN'T JOIN GROUPS
